...
export default function Orb({
  ...
  color1 = "#8ebfd4", // Cosmosphyr Ice Blue (--color-accent-ice)
  color2 = "#52a8d8", // Cosmosphyr Electric Cyan
  color3 = "#061326", // Cosmosphyr Deep Space Navy
  scale = 1.0,
  className = "",
}: OrbProps) {
  ...
  const frag = /* glsl */ `
    ...
    vec4 mainImage(vec2 fragCoord) {
      ...
      vec2 uv = ((fragCoord - center) / (size * max(0.1, orbScale))) * 2.0;
